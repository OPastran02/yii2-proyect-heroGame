...
class nature extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(User::class, ['id' => 'created_by'])->inverseOf('natures');
    }
    ...
    {
        return $this->hasMany(Heroes::class, ['nature_id' => 'id'])->inverseOf('nature');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'updated_by'])->inverseOf('natures0');
    }

    /**
     * {@inheritdoc}
     * @return \common\models\query\natureQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\natureQuery(get_called_class());
    }
}
