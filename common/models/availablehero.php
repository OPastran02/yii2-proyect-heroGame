...
class availablehero extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'b_attack_min' => 'Boost attack Min',
            'b_Battack_max' => 'Boost attack Max',
            'defense_min' => 'Defense Min',
            'defense_max' => 'Defense Max',
            'b_defense_min' => 'Boost defense Min',
            'b_defense_max' => 'Boost defense Max',
            'hp_min' => 'Hp Min',
            'hp_max' => 'Hp Max',
            'b_hp_min' => 'Boost Hp Min',
            'b_hp_max' => 'Boost Hp Max',
            'sp_attack_min' => 'Special Attack Min',
            'sp_attack_max' => 'Special Attack Max',
            'b_sp_attack_min' => 'Boost special Attack Min',
            'b_sp_attack_max' => 'Boost special Attack Max',
            'sp_defense_min' => 'Special Defense Min',
            'sp_defense_max' => 'Special Defense Max',
            'b_sp_defense_min' => 'Boost special Defense Min',
            'b_sp_defense_max' => 'Boost special Defense Max',
            'speed_min' => 'Speed Min',
            'speed_max' => 'Speed Max',
            'b_speed_min' => 'Boost Speed Min',
            'b_speed_max' => 'Boost Speed Max',
            'farming_min' => 'Farming Min',
            'farming_max' => 'Farming Max',
            'b_farming_min' => 'Boost Farming Min',
            'b_farming_max' => 'Boost Farming Max',
            'steeling_min' => 'Steeling Min',
            'steeling_max' => 'Steeling Max',
            'b_steeling_min' => 'Boost Steeling Min',
            'b_steeling_max' => 'Boost Steeling Max',
            'wooding_min' => 'Wooding Min',
            'wooding_max' => 'Wooding Max',
            'b_wooding_min' => 'Boost Wooding Min',
            'b_wooding_max' => 'Boost Wooding Max',
            'available' => 'Available',
