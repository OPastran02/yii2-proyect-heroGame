...
class playerworld extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(User::class, ['id' => 'created_by'])->inverseOf('playerworlds');
    }
    ...
    {
        return $this->hasOne(Players::class, ['id' => 'player_id'])->inverseOf('playerworlds');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'updated_by'])->inverseOf('playerworlds0');
    }
    ...
    {
        return $this->hasOne(Worlds::class, ['id' => 'worlds_id'])->inverseOf('playerworlds');
    }

    /**
     * {@inheritdoc}
     * @return \common\models\query\playerworldQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\playerworldQuery(get_called_class());
    }
}
