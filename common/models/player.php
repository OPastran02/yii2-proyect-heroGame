...
class player extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(User::class, ['id' => 'created_by'])->inverseOf('players');
    }

    /**
     * Gets query for [[GuildsPlayers]].
     *
     * @return \yii\db\ActiveQuery|\common\models\query\GuildsPlayersQuery
     */
    public function getGuildsPlayers()
    {
        return $this->hasMany(GuildsPlayers::class, ['player_id' => 'id'])->inverseOf('player');
    }
    ...
    {
        return $this->hasMany(Heroes::class, ['player_id' => 'id'])->inverseOf('player');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'id'])->inverseOf('player');
    }
    ...
    {
        return $this->hasMany(PlayersWorlds::class, ['player_id' => 'id'])->inverseOf('player');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'updated_by'])->inverseOf('players0');
    }
