 ...
 */
class accesory extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(User::class, ['id' => 'created_by'])->inverseOf('accesories');
    }
    ...
    {
        return $this->hasMany(Heroes::class, ['accesories_id' => 'id'])->inverseOf('accesories');
    }
    ...
    {
        return $this->hasMany(Heroes::class, ['accesories_id1' => 'id'])->inverseOf('accesoriesId1');
    }
    ...
    {
        return $this->hasMany(Heroes::class, ['accesories_id2' => 'id'])->inverseOf('accesoriesId2');
    }
    ...
    {
        return $this->hasOne(Rarity::class, ['id' => 'rarity_id'])->inverseOf('accesories');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'updated_by'])->inverseOf('accesories0');
    }

    /**
     * {@inheritdoc}
     * @return \common\models\query\accesoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\accesoryQuery(get_called_class());
    }
}
